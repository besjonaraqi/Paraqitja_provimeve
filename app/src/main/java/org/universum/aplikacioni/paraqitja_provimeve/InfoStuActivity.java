...
public class InfoStuActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButtonProfile.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent objIntent = new Intent(InfoStuActivity.this, StudentActivity.class);
        ...
        mImageButtonProvimet.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent objIntent = new Intent(InfoStuActivity.this, ProvimetStuActivity.class);
                        startActivity(objIntent);
                    }
                });
        mImageButtonLogout.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent objIntent = new Intent(InfoStuActivity.this, InfoStuActivity.class);
                        startActivity(objIntent);
                    }
                });
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(InfoStuActivity.this, MainActivity.class);
